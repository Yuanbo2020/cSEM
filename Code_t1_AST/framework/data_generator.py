...
def ast_normalize():
    ...
    hdf5_file = os.path.join(dir_path, 'ast_D2018T1A_training.h5')
    ...
    if not os.path.exists(hdf5_file):
        ...
        file_path = os.path.join(dir_path, 'ast_D2018T1A_feature_original_998_128.pickle')
...
class DataGenerator_ast_scene(object):
    def __init__(self, hdf5_path, batch_size=config.batch_size,
                 dev_train_csv=config.dev_train_csv,
                 dev_validate_csv=config.dev_validate_csv,
                 dev_test_csv=config.dev_evaluate_csv, seed=42):
        """
        Inputs:
          hdf5_path: str
          batch_size: int
    ...
    def generate_train(self):
        ...
        while True:
            ...
            # print('shape: ', batch_x.shape, batch_y.shape)
            # shape:  (4, 1024, 128) (4,)
