...
class DataGenerator_scene_event(object):
    ...
    def __init__(self, hdf5_path, normalization, batch_size=config.batch_size, dev_train_csv=config.dev_train_csv,
                 dev_validate_csv=config.dev_validate_csv, dev_test_csv=config.dev_evaluate_csv,  seed=1234):
        """
        Inputs:
          hdf5_path: str
          batch_size: int
        ...
        file = os.path.join(config.dataset_dir, 'PANN', 'pseudo_tagging_hard_labels.pkl')
        self.pseudo = True
    ...
    def generate_train(self):
        ...
        while True:
            ...
            # print('shape: ', batch_x.shape, batch_y.shape, batch_y_event.shape)
            # shape:  (64, 320, 64) (64,) (64, 527)
            if self.pseudo:
